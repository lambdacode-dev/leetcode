...
echo "| Leetcode # | Leetcode Link | Time Complexity | Space Complexity |" >> README.md
echo "| --- | --- | --- | --- |" >> README.md
for f in $files; do
    ...
    echo "| $problemid | [$problem](https://leetcode.com/problems/$url/) | ${timespacearr[0]} |${timespacearr[1]} |" >> README.md
done
